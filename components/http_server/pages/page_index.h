/* Index page template - ESP32 Ethernet-WiFi Bridge status */

#define INDEX_TITLE "ESP32 Ethernet-WiFi Bridge"
...
background: linear-gradient(135deg, #1a1510 0%, #1e1a12 100%);\
color: #e0e0e0;\
padding: 1rem;\
min-height: 100vh;\
line-height: 1.6;\
